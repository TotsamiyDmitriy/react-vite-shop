...
import { CatalogList, CatalogSettings, SortBy } from '../components';
    ...
    <div className={styles.main} id="root">
      <div className={styles.container}>
        <div className={styles.settings}>
          <div
            className={`${styles.filters}${filtersBtn ? ` ${styles.active}` : ''}`}
